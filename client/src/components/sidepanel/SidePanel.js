...
const SidePanel = () => {
  return (
    <div className={styles.sidepanel}>
       ...
       <Select placeholder='Select a course' _hover={{ bg: "rgb(61, 61, 61)" }} borderColor='rgb(100, 100, 102)'>
          <option value='cpsc455'>CPSC455</option>
          <option value='cpsc310'>CPSC310</option>  
          <option value='cpsc320'>CPSC320</option>
        </Select>
        <Button mt={4} width='100%' bg='transparent' _hover={{ bg: "rgb(61, 61, 61)" }} border='1px' borderColor='rgb(100, 100, 102)'>+ New Chat</Button>
       </div>
