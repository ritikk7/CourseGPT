...
async function queryMessage(query, model, tokenBudget) {
  ...
  const introduction =
    'Use the below information on the University of British Columbia CPSC455 - Applied Industry Practices course to answer the subsequent question. If the answer cannot be found in the provided information, write "I could not find an answer."';
  const question = `\n\nQuestion: ${query}`;
...
async function ask(
  ...
  if (courseId == '6492222f349939b24dc08c90') {
    ...
    systemContext =
      'the University of British Columbia CPSC455 - Applied Industry Practices course.';
